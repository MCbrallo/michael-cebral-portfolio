...
export default function AboutPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white relative overflow-hidden">
            ...
            <div className="max-w-[1200px] mx-auto px-6 md:px-12 pt-20 pb-20 relative z-10">

                <div className="mb-4">
                    <Link
                        href="/"
                        className="inline-flex items-center text-white/50 hover:text-white transition-colors group uppercase tracking-widest text-[10px]"
                    >
                ...
                <div className="mb-8 animate-fade-in">
                    <div className="border-b border-white/10 pb-6 mb-6 relative flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
                        {/* Premium accent line */}
                        ...
                        <div className="flex-1 flex flex-col md:flex-row gap-8 items-center md:items-start w-full">
                            <div className="max-w-2xl relative z-10">
                                <h1 className="font-serif text-4xl md:text-5xl font-normal tracking-tight mb-4 text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-white/60">
                                    {t.about?.title}
                                </h1>
